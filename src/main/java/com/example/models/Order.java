...
public class Order {
    ...
    public Order(String orderId, String productId, String accountId, TypeProduct productType, int quantity, float price, byte discount, int tax, LocalDate orderDate) {
